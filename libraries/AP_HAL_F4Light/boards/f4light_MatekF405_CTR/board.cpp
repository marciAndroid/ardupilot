...
*/
    ...
    {&gpiob,   NULL, NULL, 10, NO_CH,     nADC}, /* D0/PB10  0 MAX7456_SPI_CS_PIN */
    ...
    {&gpioc,   NULL,&_adc1, 0, NO_CH,       10}, /* D6/PC0   6 */
    {&gpioc,   NULL,&_adc1, 1, NO_CH,       11}, /* D7/PC1   7 SD CS */
    {&gpioc,   NULL,&_adc1, 2, NO_CH,       12}, /* D8/PC2   8 CS_MPU6000 */
    ...
    {&gpioc,   NULL, NULL, 13, NO_CH,     nADC}, /* D19/PC13 9 Buzzer */
    {&gpioc,   NULL, NULL, 14, NO_CH,     nADC}, /* D20/PC14 20 n/a */
    {&gpioc,   NULL, NULL, 15, NO_CH,     nADC}, /* D21/PC15 1  n/a */
    {&gpioa, &timer1,NULL,  8, TIMER_CH1, nADC}, /* D22/PA8  2 SERVO_6 */
    ...
    {&gpiod,   NULL, NULL,  3, NO_CH,     nADC}, /* D27/PD3  7 n/a */
    {&gpiod,   NULL, NULL,  6, NO_CH,     nADC}, /* D28/PD6  8 n/a */
    ...
    {&gpiob, &timer4,NULL,  6, TIMER_CH1, nADC}, /* D37/PB6  7  SCL pad */
    {&gpiob, &timer4,NULL,  7, TIMER_CH2, nADC}, /* D38/PB7  8  SDA pad */
    ...
    {&gpiob, &timer3,&_adc1,1, TIMER_CH4,    9}, /* D45/PB1  5  RSSI */
    {&gpiob, &timer3,&_adc1,0, TIMER_CH3,    8}, /* D46/PB0  6   */
    ...
    {&gpioa,   NULL, &_adc1,4, NO_CH,        4}, /* D51/PA4  1  */
    ...
    {&gpiob,   NULL, NULL, 11, NO_CH,     nADC}, /* D100/PB11 100 */
    {&gpiob, &timer4,NULL,  8, TIMER_CH3, nADC}, /* D101/PB8    */
    {&gpioe,   NULL, NULL,  2, NO_CH,     nADC}, /* D102/PE2 */
    {&gpioa, &timer2,NULL, 15, TIMER_CH1, nADC}, /* D103/PA15 SERVO_5 */
    ...
    {&gpioa,   NULL, NULL, 14, NO_CH,     nADC}, /* D107/PA14 SWCLK  LED */
...
//               name            device   bus  mode         cs_pin                 speed_low       speed_high   dma               priority
     ...
     { BOARD_SDCARD_NAME,        _SPI3,   3,  SPI_MODE_3, 255,                     SPI_1_125MHZ,   SPI_18MHZ,  SPI_TRANSFER_DMA, DMA_Priority_Medium,     0,          0 }, 
     { BOARD_OSD_NAME,           _SPI2,   2,  SPI_MODE_0, BOARD_OSD_CS_PIN,        SPI_1_125MHZ,   SPI_4_5MHZ, SPI_TRANSFER_DMA, DMA_Priority_Low,        2,          2 },
//     { BOARD_DATAFLASH_NAME,     _SPI3,   3,  SPI_MODE_3, 255/*device controls CS*/,SPI_1_125MHZ,  SPI_18MHZ,  SPI_TRANSFER_DMA, DMA_Priority_High,       1,          1 },
};
